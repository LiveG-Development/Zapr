    ...
    def do_GET(self):
        ...
        try:
            ...
            try:
                ...
                self.send_header("Content-type", "text/html")
                self.end_headers()
                self.wfile.write(b"<h1>Error 404</h1><p>The requested file could not be found.</p><small>LiveG Zapr | <a href='https://liveg.tech'>liveg.tech</a></small>")

def serve():
    servingDir = os.path.join(os.getcwd(), "build")
